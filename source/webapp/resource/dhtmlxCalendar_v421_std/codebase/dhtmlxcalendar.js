...
if (typeof (window.dhx4) == "undefined") {
    window.dhx4 = {version: "4.2.1", skin: null, skinDetect: function(a) {
...
if (typeof (window.dhx4.dateLang) == "undefined") {
    ...
    window.dhx4.dateStrings = {en: {monthFullName: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"],
            monthShortName: ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"], 
            dayFullName: ["星期日","星期一", "星期二", "星期三", "星期四", "星期五", "星期六"],
            dayShortName: ["日", "一", "二", "三", "四", "五", "六"]}};
    ...
    window.dhx4.str2date = function(g, s, x) {
        ...
        for (var b = 0; b < u.length; b++) {
            switch (j[b]) {
                ...
                case"%u":
                    if (!isNaN(u[b])) {
                        a[{"%d": "setDate", "%j": "setDate", "%n": "setMonth", "%m": "setMonth", "%Y": "setFullYear", "%H": "setHours", "%G": "setHours", "%i": "setMinutes", "%s": "setSeconds", "%u": "setMilliseconds"}[j[b]]](Number(u[b]) + (j[b] == "%m" || j[b] == "%n" ? -1 : 0))
                    }
                    break;
                case"%M":
                case"%F":
...
if (typeof (window.dhx4.ajax) == "undefined") {
    window.dhx4.ajax = {cache: false, method: "get", parse: function(a) {
            if (typeof a !== "string") {
                return a
            }
            a = a.replace(/^[\s]+/, "");
...
if (!window.dhtmlxValidation) {
    ...
    dhtmlxValidation.prototype = {isEmpty: function(a) {
            return a == ""
...
if (typeof (window.dhtmlx) == "undefined") {
    window.dhtmlx = {extend: function(d, c) {
            for (var e in c) {
                if (!d[e]) {
                    d[e] = c[e]
                }
...
function dhtmlXCalendarObject(f, k) {
    ...
    this.conf = {skin: (k || window.dhx4.skin || (typeof (dhtmlx) != "undefined" ? dhtmlx.skin : null) || window.dhx4.skinDetect("dhtmlxcalendar") || "dhx_skyblue"), zi: window.dhx4.newId(), touch: !window.dhx4.isIE, ws_first: true};
    ...
    this._show = function(r, a) {
        ...
        if (!r) {
            ...
            if (this.pos == "right") {
                ...
                if (this.pos == "bottom") {
                    var q = this._getTop(n) + n.offsetHeight + 1;
                    if (q + this.base.offsetHeight > m) {
                        var p = this._getTop(n) - this.base.offsetHeight;
                        if (p >= -20) {
                            q = p
                        }
                    }
    ...
    this._posGetOffsetRect = function(n) {
        ...
        var t = q.top + a - p;
        var m = q.left + o - s;
        return{top: Math.round(t), left: Math.round(m)}
    };
        ...
        for (var o = 0; o < this.contDates.childNodes.length; o++) {
            for (var a = 0; a < this.contDates.childNodes[o].childNodes.length; a++) {
                ...
                if (r._date != null && r._date.getTime() == n) {
                    l = {x: this._getLeft(r), y: this._getTop(r), w: r.offsetWidth, h: r.offsetHeight}
                }
                r = null
            }
        }
...
dhtmlXCalendarObject.prototype.langData = {en: 
            {dateformat: "%Y-%m-%d", hdrformat: "%F %Y", monthesFNames: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"], 
        monthesSNames: ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"], 
        daysFNames: ["星期日","星期一", "星期二", "星期三", "星期四", "星期五", "星期六"], 
        daysSNames: ["日", "一", "二", "三", "四", "五", "六"], weekstart: 1, weekname: "w"}};
