...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        ,toolbar:[
            'source image undo redo | bold italic underline strikethrough | superscript subscript | forecolor backcolor | removeformat |',
...
//为编辑器实例添加一个路径，这个不能被注释
       ...
       // ,imagePath:URL + "php/"           //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        ,toolbars:[["FullScreen","Source","Undo","Redo","InsertUnorderedList","InsertOrderedList","Unlink","Link","Print","SearchReplace","Preview","GMap","InsertImage","Emotion","InsertVideo","Attachment","Date","Map","Horizontal","Spechars","background","Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","Superscript","Subscript","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","Indent","RemoveFormat","FormatMatch","RowSpacingBottom","Paragraph","RowSpacingTop","LineHeight","FontFamily","FontSize","ImageNone","ImageLeft","ImageRight","ImageCenter"]]
