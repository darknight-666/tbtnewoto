...
if (YII_TBTENV == 1) {//生产
    return array(
        ...
        'acpsdk' => array(
            ...
            'acpsdk.frontUrl' => '',
            'acpsdk.payFrontUrl' => '',
            'acpsdk.signCert.path' => dirname(__FILE__).'/' . '../extensions/UnionPay/certs/product/acp_prod_sign.pfx',
            'acpsdk.signCert.pwd' => '',
            'acpsdk.encryptCert.path' => dirname(__FILE__).'/' . '../extensions/UnionPay/certs/product/acp_prod_enc.cer',
            'acpsdk.middleCert.path' => dirname(__FILE__).'/' . '../extensions/UnionPay/certs/product/acp_prod_middle.cer',
            'acpsdk.rootCert.path' => dirname(__FILE__) .'/'. '../extensions/UnionPay/certs/product/acp_prod_root.cer',
            'acpsdk.log.file.path' => dirname(__FILE__) .'/'. '../runtime/logs/',
    ...
    return array(
        ...
        'acpsdk' => array(
            ...
            'acpsdk.backUrl' => 'http://oto.tongbaotu.new/shop/pay/ReceiveOpenBack',
            'acpsdk.frontUrl' => 'http://oto.tongbaotu.new/shop/pay/openBack',
            'acpsdk.payBackUrl' => 'http://oto.tongbaotu.new/shop/pay/ReceivePayBack',
            'acpsdk.payFrontUrl' => 'http://oto.tongbaotu.new/shop/pay/payBack',
            'acpsdk.signCert.path' => dirname(__FILE__) .'/'. '../extensions/UnionPay/certs/test/acp_test_sign.pfx',
            'acpsdk.signCert.pwd' => '000000',
            'acpsdk.encryptCert.path' => dirname(__FILE__).'/' . '../extensions/UnionPay/certs/test/acp_test_enc.cer',
            'acpsdk.middleCert.path' => dirname(__FILE__).'/' . '../extensions/UnionPay/certs/test/acp_test_middle.cer',
            'acpsdk.rootCert.path' => dirname(__FILE__) .'/'. '../extensions/UnionPay/certs/test/acp_test_root.cer',
            'acpsdk.log.file.path' => dirname(__FILE__) .'/'. '../runtime/logs/',
